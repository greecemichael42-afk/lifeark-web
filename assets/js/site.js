...
const hdr=document.getElementById('hdr');
  ...
  if(orderModal){
    ...
    const BOOK_KEYS=[{k:'رُكوب الموج',key:'rokoub'},{k:'العقل الصافي',key:'clear-mind'},{k:'المِيزان',key:'mizan'},{k:'اليقظة الذهنية',key:'hurriya'}];
    ...
    const ORDER_PRICES=[
      ...
      {k:'اليقظة الذهنية', ar:'حوّل قيمة الكتاب (1000 ج.م / $50) إلى:', en:'Transfer the book price (1000 EGP / $50) to:'}
    ];
